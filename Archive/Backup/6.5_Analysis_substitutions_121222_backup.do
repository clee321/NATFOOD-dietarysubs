...
foreach file in `files'{
	...
	*Substring used later to save the file name - remove 8 characters suffix
	...
	merge 1:m food_code using "$Data/NHANES/2015-2016/NHANES_WWEIA_DataFRIENDS_WWEIAup_2015-16_ghgcons_allsubpop.dta", generate(_merge_seqn)
...
* count Seqn before dropping duplicates - compare to the other lists (Substitutions/Step 2-3, seqn list)
* Protein  1,456 -> 1,281
