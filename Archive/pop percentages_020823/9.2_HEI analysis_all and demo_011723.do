...
foreach file in `files'{
	...
	**#eduCat
	forval f=1/4 {
		...
		//original
		svy, subpop (if subpop==1 & eduCat==`f'): mean (oHEI2015*)
		...
		putexcel set "$Results/2015-16/HEI/Overall pop/HEI_`filename'_all_bydemo.xlsx", sheet ("eduCat_`f'") modify
		...
		//substituted
		svy, subpop (if subpop==1 & eduCat==`f'): mean (sHEI2015*)
		...
		//difference
		svy, subpop (if subpop==1 & eduCat==`f'): mean (diff_HEI2015*)
	...
	**#pirCat
	foreach f of numlist 1/4 99 {
		...
		//original
		svy, subpop (if subpop==1 & pirCat==`f'): mean (oHEI2015*)
		...
		putexcel set "$Results/2015-16/HEI/Overall pop/HEI_`filename'_all_bydemo.xlsx", sheet ("pirCat_`f'") modify
		...
		//substituted
		svy, subpop (if subpop==1 & pirCat==`f'): mean (sHEI2015*)
		...
		//difference
		svy, subpop (if subpop==1 & pirCat==`f'): mean (diff_HEI2015*)
