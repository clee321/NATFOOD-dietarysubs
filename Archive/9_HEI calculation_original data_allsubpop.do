...
use "$Data/NHANES/2015-2016/NHANES_WWEIA_DataFRIENDS_WWEIAup_2015-16_ghgcons_allsubpop", clear
...
mdesc grams
tab drxfcsd if grams==.
tab drxfcsd if DR1T_F_CITMLB==.
...
save "$Analysis/HEI/Intermediate/NHANES_DEMO_GHG_FPED_for HEI calc_orig_allsubpop.dta", replace
  
********
use "$Analysis/HEI/Intermediate/NHANES_DEMO_GHG_FPED_for HEI calc_orig_allsubpop.dta", clear
...
save "$Analysis/HEI/2015-16 HEI Total Score per seqn_allpop.dta", replace
