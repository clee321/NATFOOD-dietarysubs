*R&R1: Compare HEI mean change across demo categories (for substituters)
...
matrix b = r(table_vs)'
matrix list b
putexcel set "$Results/2015-16/HEI/Substituters/RR1/Pairwise comparisons_HEI_bydemo_`filename'.xlsx", sheet("agecat") modify
...
matrix b = r(table_vs)'
matrix list b
putexcel set "$Results/2015-16/HEI/Substituters/RR1/Pairwise comparisons_HEI_bydemo_`filename'.xlsx", sheet("gendercat") modify
...
matrix b = r(table_vs)'
matrix list b
putexcel set "$Results/2015-16/HEI/Substituters/RR1/Pairwise comparisons_HEI_bydemo_`filename'.xlsx", sheet("racecat") modify
