...
**#Analysis for only Seqns with substitutions
*********
**Mean changes in GHG emissions and nutrition outcomes per person per day after substitutions among those with substitutions.
...
** count if subpop==1 & sub_flag==1  1,281; 1,653
...
foreach file in `files'{
	...
	**#Original
	...
	matlist p
		...
		putexcel set "$Results/2015-16/Mean_nutri_ghg/Mean_nutri_ghg_seqn_subflag.xlsx", sheet ("`filename'") modify
