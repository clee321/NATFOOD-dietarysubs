...
foreach file in `files'{
	...
	**Mean Percent Difference
	*Calculate percent change (mean of individual percent changes)
	svy, subpop (if subpop==1 & sub_flag==1 & ageCat==`f'): mean (perc_grams-perc_ghgcons)
	...
	**#Total ghg difference across the entire sample for one day
	**Original
	svy, subpop (if subpop==1 & sub_flag==1 & ageCat==`f'): total (ttl_orighgcons)
	display %12.0g _b[ttl_orighgcons]
	...
	**Substituted
	svy, subpop (if subpop==1 & sub_flag==1 & ageCat==`f'): total (ttl_subghgcons)
	display %12.0g _b[ttl_subghgcons]
...
foreach file in `files'{
	...
	**#genderCat
	forval f=1/2 {
		...
		//%difference
	svy, subpop (if subpop==1 & sub_flag==1 & genderCat==`f'): mean (perc_grams-perc_ghgcons)
	...
	**#Total ghg difference across the entire sample for one day
	**Original
	svy, subpop (if subpop==1 & sub_flag==1 & genderCat==`f'): total (ttl_orighgcons)
	display %12.0g _b[ttl_orighgcons]
	...
	**Substituted
	svy, subpop (if subpop==1 & sub_flag==1 & genderCat==`f'): total (ttl_subghgcons)
	display %12.0g _b[ttl_subghgcons]
...
foreach file in `files'{
	...
	**#raceCat //5 race/ethn categories
	forval f=1/5 {
		...
		//%difference
		svy, subpop (if subpop==1 & sub_flag==1 & raceCat==`f'): mean (perc_grams-perc_ghgcons)
	...
	**#Total ghg difference across the entire sample for one day
	**Original
	svy, subpop (if subpop==1 & sub_flag==1 & raceCat==`f'): total (ttl_orighgcons)
	display %12.0g _b[ttl_orighgcons]
	...
	**Substituted
	svy, subpop (if subpop==1 & sub_flag==1 & raceCat==`f'): total (ttl_subghgcons)
	display %12.0g _b[ttl_subghgcons]
