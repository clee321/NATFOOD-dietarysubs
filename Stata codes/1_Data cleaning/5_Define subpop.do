...
recode ridreth3 (3=1) (4=2) (1/2=3) (6=4) (7=5) (.=.), generate (raceCat)
label define race_Labels 1"Non-Hispanic White" 2"Non-Hispanic Black" 3"Mexican American and other Hispanic" 4"Non-Hispanic Asian" 5"Other Race"
...
gen subpop = .
replace subpop = 1 if ridageyr >= 2 & ridageyr !=. & riagendr !=. & eduCat !=. & pirCat !=. & ridreth3 !=. & wtdrd1 !=.
replace subpop = 0 if (ridageyr < 2 | ridageyr ==. | riagendr ==. | eduCat ==. | pirCat ==. | ridreth3 ==. | wtdrd1 ==.)

tab subpop

save "$Data/NHANES/2015-2016/v2_racecat/NHANES_WWEIA_DataFRIENDS_WWEIAup_2015-16_subpop_v2.dta", replace
