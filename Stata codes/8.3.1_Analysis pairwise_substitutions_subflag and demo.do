...
matrix c = r(table_vs)'
matrix list c
putexcel set "$Results/2015-16/Mean_nutri_ghg/Substituters/Pairwise comparisons_ghg_bydemo_allcombs_`filename'.xlsx", sheet("agecat") modify
...
matrix b = r(table)'
matrix list b
putexcel set "$Results/2015-16/Mean_nutri_ghg/Substituters/Pairwise comparisons_ghg_bydemo2_`filename'.xlsx", sheet("agecat") modify
putexcel A1 = ("AgeCat Pairwise comparisons")
putexcel A2 = "Bonferroni adjustment"
putexcel C1 = ("Age_Labels 0: 0-1 | 1: 2-5 | 2: 6-11 | 3: 12-17 | 4: 18-25 | 5: 26-39 | 6: 40-49 | 7: 50-59 | 8: 60 and over")
putexcel B1= "`e(cmdline)'"
...
matrix c = r(table_vs)'
matrix list c
putexcel set "$Results/2015-16/Mean_nutri_ghg/Substituters/Pairwise comparisons_ghg_bydemo_allcombs_`filename'.xlsx", sheet("gendercat") modify
...
matrix b = r(table)'
matrix list b
putexcel set "$Results/2015-16/Mean_nutri_ghg/Substituters/Pairwise comparisons_ghg_bydemo2_`filename'.xlsx", sheet("gendercat") modify
putexcel A1 = ("GenderCat Pairwise comparisons")
putexcel A2 = "No p-value adjustment"
putexcel C1 = ("Gender_Labels 1: Male 2: Female")
putexcel B1= "`e(cmdline)'"
...
matrix c = r(table_vs)'
matrix list c
putexcel set "$Results/2015-16/Mean_nutri_ghg/Substituters/Pairwise comparisons_ghg_bydemo_allcombs_`filename'.xlsx", sheet("racecat") modify
...
matrix b = r(table)'
matrix list b
putexcel set "$Results/2015-16/Mean_nutri_ghg/Substituters/Pairwise comparisons_ghg_bydemo2_`filename'.xlsx", sheet("racecat") modify
putexcel A1 = ("RaceCat Pairwise comparisons")
putexcel A2 = "Bonferroni adjustment"
putexcel C1 = ("race_Labels 1: Non-Hispanic White | 2: Non-Hispanic Black | 3: Mexican American and other Hispanic | 4: Non-Hispanic Asian | 5: Other Race")
putexcel B1= "`e(cmdline)'"
