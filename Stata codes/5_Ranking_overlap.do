...
import excel "$Analysis/Ranking/2015-16/total_ghg/Analysis_foodcodes_ghgconsumed_weighted.xlsx", sheet("`majorlongname'") firstrow clear
...
save "$Analysis/Ranking/2015-16/overlap/IntermediateData/`major'_totalGHG_ranked.dta", replace



*Intensity GHG Ranking

import excel "$Analysis/Ranking/2015-16/ghg_intensity/Analysis_foodcodes_ghg.xlsx", sheet("`majorlongname'") firstrow clear
...
gen top`topx'_ghg100 = .
	...
	save "$Analysis/Ranking/2015-16/overlap/IntermediateData/`major'_GHG100_ranked.dta", replace

	
*Merge lists
merge 1:1 food_code using "$Analysis/Ranking/2015-16/overlap/IntermediateData/`major'_totalGHG_ranked.dta"
...
export excel using "$Analysis/Ranking/2015-16/overlap/`major'_RankedOverlap.xlsx", firstrow(variables) replace

*Format excel 
putexcel set "$Analysis/Ranking/2015-16/overlap/`major'_RankedOverlap.xlsx", modify
